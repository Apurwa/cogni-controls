	...
	<form action="/" method="post">
		<div class="col-sm-12">
			<div class="login-control col-sm-4">
			  ...
			  <input type="radio" class="form-control" name="control_num" value="control1" id="control1">
			</div>
			<div class="login-control col-sm-4">
				<label for="control2">Control-2</label>			
			  <input type="radio" class="form-control" name="control_num" value="control2" id="control2">
			</div>
			<div class="login-control col-sm-4">
